...
//        The loop for get all events in jsonArray
    ...
    private JSONObject eventJson(WebElement element) throws JSONException {
        ...
        jsonEvent.put("data",element.findElement(By.className("_30aNOe5fOsKvCNDWBpBYDv")).getText());
        jsonEvent.put("team1",element.findElements(By.className("_2-4kPKVpNrNoq_0Ylv6TFX")).get(0).getText());
        jsonEvent.put("team2",element.findElements(By.className("_2-4kPKVpNrNoq_0Ylv6TFX")).get(1).getText());
        jsonEvent.put("x1", element.findElements( By.className("_1TBLfOVfJx5AZbnqsME6Y5")).get(0).getText());
        jsonEvent.put("x2",element.findElements( By.className("_1TBLfOVfJx5AZbnqsME6Y5")).get(1).getText());
